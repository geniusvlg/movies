package com.fact.nash.extension.caching.mem_cache;
...
public class InMemoryCache <K, T>{
    ...
    /**
     * LRUMap: A Map implementation with a fixed maximum size which removes the least recently used entry if an entry
     * is added when full. The least recently used algorithm works on the get and put operations only.
    ...
    public T remove(K key) {
        CacheObject val = (CacheObject) cacheMap.get(key);
