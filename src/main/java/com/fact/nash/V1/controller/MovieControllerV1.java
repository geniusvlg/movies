...
import com.fact.nash.V1.serializer.DhMovieSerializerV1;
...
public class MovieControllerV1 {
    ...
    @Autowired
    DhMovieSerializerV1 dhMovieSerializerV1;
    ...
    ResponseEntity<?> fetch(@RequestBody DhDataRequestV1 request) throws IOException, ParseException,
        ...
        DhDataResponseV1 responseV1 = dhMovieSerializerV1.parseToDatahubResponse(request.getDatesList(), movies);
